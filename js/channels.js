...
/* reference channels in a global array named channels */
var channels = [yummy, sevencontinents, killerapp, firstpersononmars, octoberfest];

function compareChannels(yummy, sevencontinents, killerapp, firstpersononmars, octoberfest){
    if (yummy.expiresIn < sevencontinents.expiresIn){
        return -1;
    }
    if (yummy.expiresIn < killerapp.expiresIn){
        return -1;
    }
    if (yummy.expiresIn < firstpersononmars.expiresIn){
        return -1;
    }
    if (yummy.expiresIn < octoberfest.expiresIn){
        return -1;
    }
}
